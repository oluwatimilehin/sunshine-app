...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler,
    ...
    private static final String PREFERRED_LOCATION = "location";
    ...
    private void loadWeatherData() {
        ...
        bundle.putString(PREFERRED_LOCATION, location);
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        ...
        String mWeatherResult[];
            ...
            public String[] loadInBackground() {
                ...
                String location = args.getString(PREFERRED_LOCATION);
                ...
                try {
                 ...
                 mWeatherResult = simpleJsonWeatherData;
